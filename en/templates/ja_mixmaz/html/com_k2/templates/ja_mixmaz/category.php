		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
				<div class="subCategory">
					...
					<!-- Subcategory title -->
					<h2 <?php if($this->params->get('subCatImage') && $subCategory->image): ?> class="hasImage" <?php endif; ?>>
						<a href="<?php echo $subCategory->link; ?>">
							<?php echo $subCategory->name; ?>
						</a>
						<?php if($this->params->get('subCatTitleItemCounter')) : ?> <?php echo '<span>('.$subCategory->numOfItems.')</span>'; ?> <?php endif ?>
					</h2>
					<?php endif; ?>
