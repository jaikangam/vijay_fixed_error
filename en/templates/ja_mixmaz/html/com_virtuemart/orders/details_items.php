...
<table width="<?php echo $widthTable ?>%" cellspacing="0" cellpadding="0" border="0" class="tbl-list">
	<tr align="left" class="sectiontableheader">
		...
		<th align="center" width="19%"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_PRODUCT_STATUS') ?></th>
	...
	?>
	<tr valign="top">
		<td align="left" colspan="2" class="product-name" >
			<a href="<?php echo $_link; ?>"><?php echo $item->order_item_name; ?></a>
			<?php if (!empty($item->product_attribute)) {
	...
	<tr class="sectiontableentry1">
		...
		<td align="right" class="priceCol"><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->order_salesPrice,$this->currency) ?></td>
	</tr>
	...
	<tr>
		...
		<?php } ?>
		<td align="right">&nbsp;</td>
		<td align="right" class="priceCol"><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->coupon_discount,$this->currency); ?></td>
	</tr>
	<?php } ?>
	...
	<tr>
		...
		<td align="right" class="priceCol"><?php echo  $this->currency->priceDisplay($rule->calc_amount,$this->currency);  ?> </td>
	</tr>
	...
	<tr>
		...
		<?php } ?>
		<td align="right">&nbsp;</td>
		<td align="right" class="priceCol"><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->order_shipment+ $this->orderdetails['details']['BT']->order_shipment_tax, $this->currency); ?></td>
	</tr>
	...
	<tr>
		...
		<?php } ?>
		<td align="right">&nbsp;</td>
		<td align="right" class="priceCol"><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->order_payment+ $this->orderdetails['details']['BT']->order_payment_tax, $this->currency); ?></td>
	</tr>
	...
	<tr class="total">
		...
		<td align="right" class="priceCol"><strong><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->order_total, $this->currency); ?></strong></td>
	</tr>
</table>
