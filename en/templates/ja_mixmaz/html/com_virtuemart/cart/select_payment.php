...
?>
	...
	<div class="buttonBar-left">
		<button name="setpayment" class="button <?php echo $buttonclass ?>" type="submit"><?php echo JText::_('COM_VIRTUEMART_SAVE'); ?></button>
		&nbsp;
	...
	<?php if ($this->found_payment_method OR (VmConfig::get('oncheckout_opc', 1) )) {
    echo "<fieldset>";
