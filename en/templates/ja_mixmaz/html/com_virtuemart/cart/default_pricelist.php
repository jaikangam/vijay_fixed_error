...
<div class="billto-shipto clearfix">
	<div class="width50 floatleft">
		...
		<div class="output-billto clearfix">
			<?php
	...
	<table class="cart-summary" cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th align="center" width="140px">
				<?php echo JText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?> / <?php echo JText::_ ('COM_VIRTUEMART_CART_ACTION') ?>
			</th>
			<?php if (VmConfig::get ('show_tax')) { ?>
			<th align="right" width="60px" class="hidden-phone"><?php echo JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?></th>
			<?php } ?>
			<th align="right" width="60px" class="hidden-phone"><?php echo JText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') ?></th>
		...
		<tr valign="top" class="sectiontableentry<?php echo $i ?>">
			...
			<td align="center">
				<?php if (VmConfig::get ('checkout_show_origprice', 1) && $this->cart->pricesUnformatted[$pkey]['discountedPriceWithoutTax'] != $this->cart->pricesUnformatted[$pkey]['priceWithoutTax']) {
			...
			<?php if (VmConfig::get ('show_tax')) { ?>
			<td class="hidden-phone" align="right"><?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('taxAmount', '', $this->cart->pricesUnformatted[$pkey], FALSE, FALSE, $prow->quantity) . "</span>" ?></td>
			<?php } ?>
			<td class="hidden-phone" align="right"><?php echo "<span class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('discountAmount', '', $this->cart->pricesUnformatted[$pkey], FALSE, FALSE, $prow->quantity) . "</span>" ?></td>
		...
		<tr class="sectiontableentry1 hidden-phone">
		...
		<tr class="sectiontableentry2 hidden-phone">
		...
		<tr class="hidden-iphone sectiontableentry<?php echo $i ?>">
		...
		<tr class="sectiontableentry1 hidden-phone" valign="top">
		...
		<tr class="ja-total-price sectiontableentry2">
			<td colspan="4" align="right"><strong><?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?>: </strong></td>
			<?php if (VmConfig::get ('show_tax')) { ?>
			<td class="hidden-phone" align="right"> <?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('billTaxAmount', '', $this->cart->pricesUnformatted['billTaxAmount'], FALSE) . "</span>" ?> </td>
			<?php } ?>
			<td class="hidden-phone" align="right"> <?php echo "<span  class='priceColor2'>" . $this->currencyDisplay->createPriceDiv ('billDiscountAmount', '', $this->cart->pricesUnformatted['billDiscountAmount'], FALSE) . "</span>" ?> </td>
			<td align="right"><div class="bold"><strong><?php echo $this->currencyDisplay->createPriceDiv ('billTotal', '', $this->cart->pricesUnformatted['billTotal'], FALSE); ?></strong></div></td>
		</tr>
		
		<?php if ($this->totalInPaymentCurrency) { ?>
		<tr class="ja-total-price sectiontableentry2 totalInPaymentCurrency">
