<?php die("Access Denied"); ?>#x#s:46008:"          1392645204<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<head>
  ...
  <title>Laptops</title>
  <link href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=13&Itemid=537" rel="canonical" />
  <link href="http://webdesigninbangalore.co.in/wereach/index.php?option=com_search&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537&amp;format=opensearch" rel="search" title="Search Wereach" type="application/opensearchdescription+xml" />
...
jQuery(document).ready(function () {
	...
	var acymailing = Array();
		...
		var captchaLink = document.getElementById('captcha_picture_formAcymailing74301').src;myregexp = new RegExp('val-([0-9]+)');
		valToChange=captchaLink.match(myregexp)[1];
		document.getElementById('captcha_picture_formAcymailing74301').src = captchaLink.replace(valToChange,valToChange+'0');
	}
//<![CDATA[
jQuery(document).ready(function() {
		jQuery('#VMmenu04_32144 li.VmClose ul').hide();
		jQuery('#VMmenu04_32144 li .VmArrowdown').click(
		function() {

			if (jQuery(this).parent().next('ul').is(':hidden')) {
				jQuery('#VMmenu04_32144 ul:visible').delay(500).slideUp(500,'linear').parents('li').addClass('VmClose').removeClass('VmOpen');
...
<div id="ja-search">
    <form action="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537" method="post" class="search">
...
<h1 class="category-name">Laptops</h1>
...
<div class="browse-view">
	...
	<div class="orderby-displaynumber clearfix">
		<div class="width70 floatleft">
			<div class="orderlistcontainer"><div class="title">Sort by</div><div class="activeOrder"><a title=" +/-" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=13&Itemid=537&dir=DESC">Product ID  +/-</a></div><div class="orderlist"><div><a title="Product Name" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=13&Itemid=537&orderby=product_name">Product Name</a></div><div><a title="Product SKU" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=13&Itemid=537&orderby=product_sku">Product SKU</a></div><div><a title="Manufacturer name" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=13&Itemid=537&orderby=mf_name">Manufacturer name</a></div></div></div>					</div>
...
Results 1 - 6 of 6			</div>
	...
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537&amp;filter_product=&amp;keyword=&amp;limit=6" selected="selected">6</option>
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537&amp;filter_product=&amp;keyword=&amp;limit=12">12</option>
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537&amp;filter_product=&amp;keyword=&amp;limit=18">18</option>
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537&amp;filter_product=&amp;keyword=&amp;limit=24">24</option>
</select>
		</div>
			...
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="laptop1" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=40&virtuemart_category_id=13&Itemid=537">
							<img src="/wereach/images/stories/virtuemart/product/resized/slider1_200x200.jpg" alt="slider1" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=40&virtuemart_category_id=13&Itemid=537" >laptop1</a></h2>
					</div>
				...
				<div class="product-info">
						...
						The Apple MacBooks have always been...					</p>
					 
					
					
					<div class="product-price marginbottom12" id="productPrice40">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >25520,00 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >23200,00 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >2320,00 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=40&virtuemart_category_id=13&Itemid=537" title="laptop1" class="product-details">Product details</a>					</p>
		...
		<div class="product floatleft width33 vertical-separator">
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="laptop2" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=43&virtuemart_category_id=13&Itemid=537">
							<img src="/wereach/images/stories/virtuemart/product/resized/slider2_200x200.jpg" alt="slider2" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=43&virtuemart_category_id=13&Itemid=537" >laptop2</a></h2>
					</div>
				...
				<div class="product-info">
					...
					<div class="product-price marginbottom12" id="productPrice43">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="price-crossed" ><div class="PricebasePriceWithTax" style="display : block;" >Base price with tax: <span class="PricebasePriceWithTax" >54847288,84 ₨</span></div></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >54847288,84 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >49861171,67 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >4986117,17 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=43&virtuemart_category_id=13&Itemid=537" title="laptop2" class="product-details">Product details</a>					</p>
		...
		<div class="product floatleft width33 ">
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="laptop3" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=44&virtuemart_category_id=13&Itemid=537">
							<img src="/wereach/images/stories/virtuemart/product/resized/img_200x200.jpg" alt="img" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=44&virtuemart_category_id=13&Itemid=537" >laptop3</a></h2>
					</div>
				...
				<div class="product-info">
										<p class="product_s_desc">
						The Apple specific high quality...					</p>
					 
					
					
					<div class="product-price marginbottom12" id="productPrice44">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >88000,00 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >80000,00 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >8000,00 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=44&virtuemart_category_id=13&Itemid=537" title="laptop3" class="product-details">Product details</a>					</p>
		...
		<div class="product floatleft width33 vertical-separator">
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="LAPTOP4" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=45&virtuemart_category_id=13&Itemid=537">
							<img src="/wereach/images/stories/virtuemart/product/resized/img6_200x200.jpg" alt="img6" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=45&virtuemart_category_id=13&Itemid=537" >LAPTOP4</a></h2>
					</div>
...
Sales Package	Laptop,...					</p>
					 
					
					
					<div class="product-price marginbottom12" id="productPrice45">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >58300,00 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >53000,00 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >5300,00 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=45&virtuemart_category_id=13&Itemid=537" title="LAPTOP4" class="product-details">Product details</a>					</p>
		...
		<div class="product floatleft width33 vertical-separator">
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="LAPTOP5" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=46&virtuemart_category_id=13&Itemid=537">
							<img src="/wereach/images/stories/virtuemart/product/resized/img5_200x200.jpg" alt="img5" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=46&virtuemart_category_id=13&Itemid=537" >LAPTOP5</a></h2>
					</div>
				...
				<div class="product-info">
										<p class="product_s_desc">
						SPECIFICATIONS OF DELL INSPIRON 15 3521...					</p>
					 
					
					
					<div class="product-price marginbottom12" id="productPrice46">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="price-crossed" ><div class="PricebasePriceWithTax" style="display : block;" >Base price with tax: <span class="PricebasePriceWithTax" >2605733,21 ₨</span></div></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >2605733,21 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >2368848,37 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >236884,84 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=46&virtuemart_category_id=13&Itemid=537" title="LAPTOP5" class="product-details">Product details</a>					</p>
		...
		<div class="product floatleft width33 ">
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="Laptop6" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=47&virtuemart_category_id=13&Itemid=537">
							<img src="/wereach/images/stories/virtuemart/product/resized/img3_200x200.jpg" alt="img3" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=47&virtuemart_category_id=13&Itemid=537" >Laptop6</a></h2>
					</div>
				...
				<div class="product-info">
					...
					<div class="product-price marginbottom12" id="productPrice47">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >26389,00 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >23990,00 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >2399,00 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=47&virtuemart_category_id=13&Itemid=537" title="Laptop6" class="product-details">Product details</a>					</p>
...
<ul class="VMmenu" id="VMmenu04_32144" >

<li class="VmClose">
	<div>
		<a href="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=15&amp;Itemid=537" >Computer Accessories</a>	</div>
</li>

<li class="VmOpen">
	<div>
		<a href="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;Itemid=537" >Laptops</a>	</div>
</li>

<li class="VmClose">
	<div>
		<a href="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=14&amp;Itemid=537" >Tablets</a>	</div>
</li>
</ul>
		</div>
    </div>
...
<div class="ja-box column ja-box-right" style="width: 25%;">
	...
	<div class="acymailing_fulldiv" id="acymailing_fulldiv_formAcymailing74301"  >
		<form id="formAcymailing74301" action="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=13&amp;categorylayout=0&amp;Itemid=537" onsubmit="return submitacymailingform('optin','formAcymailing74301')" method="post" name="formAcymailing74301"  >
		<div class="acymailing_module_form" >
			<div class="acymailing_introtext"><span style="color:#000;font-size:12px;text-align:justify;">Make sure you dont miss interesting happenings by joining our newsletter program. We don't do spam. Ever. Because that sucks.</span></div>						<div class="acymailing_form">
					<p class="onefield fieldacyemail" id="field_email_formAcymailing74301">								<span class="acyfield_email"><input id="user_email_formAcymailing74301" placeholder="E-mail" class="inputbox" type="text" name="user[email]" style="width:80%" value="" /></span>
							</p>
					
					<p class="acysubbuttons">
												<input class="button subbutton btn btn-primary" type="submit" value="Subscribe" name="Submit" onclick="try{ return submitacymailingform('optin','formAcymailing74301'); }catch(err){alert('The form could not be submitted '+err);return false;}"/>
											</p>
				</div>
						<input type="hidden" name="ajax" value="0"/>
			<input type="hidden" name="ctrl" value="sub"/>
			<input type="hidden" name="task" value="notask"/>
			<input type="hidden" name="redirect" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_virtuemart%26view%3Dcategory%26virtuemart_category_id%3D13%26categorylayout%3D0%26Itemid%3D537"/>
			<input type="hidden" name="redirectunsub" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_virtuemart%26view%3Dcategory%26virtuemart_category_id%3D13%26categorylayout%3D0%26Itemid%3D537"/>
