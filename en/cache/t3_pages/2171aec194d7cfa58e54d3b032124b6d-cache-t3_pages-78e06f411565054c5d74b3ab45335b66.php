<?php die("Access Denied"); ?>#x#s:25643:"          1399533186<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<head>
  ...
  <title>Forum</title>
  <link href="http://webdesigninbangalore.co.in/wereach/index.php?option=com_search&amp;view=article&amp;id=147&amp;Itemid=666&amp;format=opensearch" rel="search" title="Search Wereach" type="application/opensearchdescription+xml" />
...
window.addEvent('load', function() {
		...
		var captchaLink = document.getElementById('captcha_picture_formAcymailing93971').src;myregexp = new RegExp('val-([0-9]+)');
		valToChange=captchaLink.match(myregexp)[1];
		document.getElementById('captcha_picture_formAcymailing93971').src = captchaLink.replace(valToChange,valToChange+'0');
	}
  </script>
...
<div id="ja-search">
    <form action="/wereach/index.php?option=com_content&amp;view=article&amp;id=147&amp;Itemid=666" method="post" class="search">
...
</div></div></li><li  class="mega"><a href="/wereach/index.php?option=com_content&amp;view=category&amp;layout=blog&amp;id=89&amp;Itemid=663"  class="mega" id="menu663" title="Blog"><span class="menu-title">Blog</span></a></li><li  class="mega active"><a href="/wereach/index.php?option=com_content&amp;view=article&amp;id=147&amp;Itemid=666"  class="mega active" id="menu666" title="Forum"><span class="menu-title">Forum</span></a></li><li  class="mega last"><a href="/wereach/index.php?option=com_contact&amp;view=contact&amp;id=1&amp;Itemid=497"  class="mega last" id="menu497" title="Contact us"><span class="menu-title">Contact us</span></a></li></ul>
...
<div class="ja-box column ja-box-right" style="width: 25%;">
    	<div class="ja-moduletable moduletable  clearfix" id="Mod99">
				...
				<div class="ja-box-ct clearfix">
		<div class="acymailing_module" id="acymailing_module_formAcymailing93971">
	<div class="acymailing_fulldiv" id="acymailing_fulldiv_formAcymailing93971"  >
		<form id="formAcymailing93971" action="/wereach/index.php?option=com_content&amp;view=article&amp;id=147&amp;Itemid=666" onsubmit="return submitacymailingform('optin','formAcymailing93971')" method="post" name="formAcymailing93971"  >
		<div class="acymailing_module_form" >
			<div class="acymailing_introtext"><span style="color:#000;font-size:12px;text-align:justify;">Make sure you dont miss interesting happenings by joining our newsletter program. We don't do spam. Ever. Because that sucks.</span></div>						<div class="acymailing_form">
					<p class="onefield fieldacyemail" id="field_email_formAcymailing93971">								<span class="acyfield_email"><input id="user_email_formAcymailing93971" placeholder="E-mail" class="inputbox" type="text" name="user[email]" style="width:80%" value="" /></span>
							</p>
					
					<p class="acysubbuttons">
												<input class="button subbutton btn btn-primary" type="submit" value="Subscribe" name="Submit" onclick="try{ return submitacymailingform('optin','formAcymailing93971'); }catch(err){alert('The form could not be submitted '+err);return false;}"/>
											</p>
				</div>
						<input type="hidden" name="ajax" value="0"/>
			<input type="hidden" name="ctrl" value="sub"/>
			<input type="hidden" name="task" value="notask"/>
			<input type="hidden" name="redirect" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_content%26view%3Darticle%26id%3D147%26Itemid%3D666"/>
			<input type="hidden" name="redirectunsub" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_content%26view%3Darticle%26id%3D147%26Itemid%3D666"/>
			<input type="hidden" name="option" value="com_acymailing"/>
						<input type="hidden" name="hiddenlists" value="1"/>
			<input type="hidden" name="acyformname" value="formAcymailing93971" />
									</div>
		</form>
	</div>
	</div>
