<?php die("Access Denied"); ?>#x#s:29473:"          1398142897<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<head>
  ...
  <link href="http://webdesigninbangalore.co.in/wereach/index.php?option=com_search&amp;view=contact&amp;id=1&amp;Itemid=497&amp;format=opensearch" rel="search" title="Search Wereach" type="application/opensearchdescription+xml" />
  ...
  <script src="/wereach/index.php?jat3action=gzip&amp;jat3type=js&amp;jat3file=t3-assets%2Fjs_47ae7.js" type="text/javascript"></script>
  <script type="text/javascript">
function keepAlive() {	var myAjax = new Request({method: "get", url: "index.php"}).send();} window.addEvent("domready", function(){ keepAlive.periodical(840000); });window.addEvent('domready', function() {
		...
		var captchaLink = document.getElementById('captcha_picture_formAcymailing65651').src;myregexp = new RegExp('val-([0-9]+)');
		valToChange=captchaLink.match(myregexp)[1];
		document.getElementById('captcha_picture_formAcymailing65651').src = captchaLink.replace(valToChange,valToChange+'0');
	}
  </script>
...
<div id="ja-search">
    <form action="/wereach/index.php?option=com_contact&amp;view=contact&amp;id=1&amp;Itemid=497" method="post" class="search">
...
<ul class="megamenu level0"><li  class="mega first"><a href="http://webdesigninbangalore.co.in/wereach/"  class="mega first" id="menu435" title="Home"><span class="menu-title">Home</span></a></li><li  class="mega"><a href="/wereach/index.php?option=com_content&amp;view=article&amp;id=135&amp;Itemid=468"  class="mega" id="menu468" title="About"><span class="menu-title">About</span></a></li><li  class="mega haschild"><a  class="mega haschild" id="menu534" title="Products"><span class="menu-title">Products</span></a><div class="childcontent cols1 ">
...
</div></div></li><li  class="mega"><a href="/wereach/index.php?option=com_content&amp;view=category&amp;layout=blog&amp;id=89&amp;Itemid=663"  class="mega" id="menu663" title="Blog"><span class="menu-title">Blog</span></a></li><li  class="mega"><a href="/wereach/index.php?option=com_content&amp;view=article&amp;id=147&amp;Itemid=666"  class="mega" id="menu666" title="Forum"><span class="menu-title">Forum</span></a></li><li  class="mega last active"><a href="/wereach/index.php?option=com_contact&amp;view=contact&amp;id=1&amp;Itemid=497"  class="mega last active" id="menu497" title="Contact us"><span class="menu-title">Contact us</span></a></li></ul>
...
<div id="system-message-container">
		...
		Let's talk	</h1>
			...
			<h3>Contact</h3>		
					...
					<div id="contact-form"> <!-- Add for Mixmaz -->
				
				
					<h3>Contact Form</h3>				
		
<div class="contact-form">
	<form id="contact-form" action="/wereach/index.php?option=com_contact&amp;view=contact&amp;id=1&amp;Itemid=497" method="post" class="form-validate">
		<fieldset>
			...
			<dl>
				...
				<dd>
					...
					<input type="hidden" name="7e68d8c1b79b45c817fa6fd0ad7a6825" value="1" />				</dd>
			</dl>
		</fieldset>
	</form>
</div>
		...
		<div id="contact-miscinfo"> <!-- Add for Mixmaz -->
		
						
					<h3>Other information</h3>				
		<div class="contact-miscinfo">
			<div class="jicons-icons">
				<img src="/wereach/media/contacts/images/con_info.png" alt="Other information: "  />			</div>
			<div class="contact-misc">
				<p><img src="images/contactus.jpg" border="0" alt="" width="2689" height="1039" /></p>
<div class="miscinfo-inner">
<div class="address">
<h4>Address</h4>
<p><strong>WeReach Infotech<br /></strong></p>
<p><span style="line-height: 1.3em;">#205, 1st Floor,1st Main, 7th Block,Near forum mall,Behind Bosch Company,Koramangala,</span></p>
<p>Bangalore.- 560095</p>
</div>
<div class="hotline"><strong>Phone:</strong><br />080 - 25701102, 9902002788 <br /><br /><strong>Email:</strong> <br />info@wereachindia.com</div>
</div>			</div>
		</div>
...
<div class="ja-box column ja-box-right" style="width: 25%;">
    	<div class="ja-moduletable moduletable  clearfix" id="Mod99">
				...
				<div class="ja-box-ct clearfix">
		<div class="acymailing_module" id="acymailing_module_formAcymailing65651">
	<div class="acymailing_fulldiv" id="acymailing_fulldiv_formAcymailing65651"  >
		<form id="formAcymailing65651" action="/wereach/index.php?option=com_contact&amp;view=contact&amp;id=1&amp;Itemid=497" onsubmit="return submitacymailingform('optin','formAcymailing65651')" method="post" name="formAcymailing65651"  >
		<div class="acymailing_module_form" >
			<div class="acymailing_introtext"><span style="color:#000;font-size:12px;text-align:justify;">Make sure you dont miss interesting happenings by joining our newsletter program. We don't do spam. Ever. Because that sucks.</span></div>						<div class="acymailing_form">
					<p class="onefield fieldacyemail" id="field_email_formAcymailing65651">								<span class="acyfield_email"><input id="user_email_formAcymailing65651" placeholder="E-mail" class="inputbox" type="text" name="user[email]" style="width:80%" value="" /></span>
							</p>
					
					<p class="acysubbuttons">
												<input class="button subbutton btn btn-primary" type="submit" value="Subscribe" name="Submit" onclick="try{ return submitacymailingform('optin','formAcymailing65651'); }catch(err){alert('The form could not be submitted '+err);return false;}"/>
											</p>
				</div>
						<input type="hidden" name="ajax" value="0"/>
			<input type="hidden" name="ctrl" value="sub"/>
			<input type="hidden" name="task" value="notask"/>
			<input type="hidden" name="redirect" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_contact%26view%3Dcontact%26id%3D1%26Itemid%3D497"/>
			<input type="hidden" name="redirectunsub" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_contact%26view%3Dcontact%26id%3D1%26Itemid%3D497"/>
