<?php die("Access Denied"); ?>#x#s:37215:"          1394268800<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<head>
  ...
  <link href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=15&Itemid=557" rel="canonical" />
  <link href="http://webdesigninbangalore.co.in/wereach/index.php?option=com_search&amp;view=category&amp;virtuemart_category_id=15&amp;categorylayout=0&amp;Itemid=557&amp;format=opensearch" rel="search" title="Search Wereach" type="application/opensearchdescription+xml" />
...
jQuery(document).ready(function () {
	...
	var acymailing = Array();
		...
		var captchaLink = document.getElementById('captcha_picture_formAcymailing44381').src;myregexp = new RegExp('val-([0-9]+)');
		valToChange=captchaLink.match(myregexp)[1];
		document.getElementById('captcha_picture_formAcymailing44381').src = captchaLink.replace(valToChange,valToChange+'0');
	}
//<![CDATA[
jQuery(document).ready(function() {
		jQuery('#VMmenu00_74186 li.VmClose ul').hide();
		jQuery('#VMmenu00_74186 li .VmArrowdown').click(
		function() {

			if (jQuery(this).parent().next('ul').is(':hidden')) {
				jQuery('#VMmenu00_74186 ul:visible').delay(500).slideUp(500,'linear').parents('li').addClass('VmClose').removeClass('VmOpen');
...
<h1 class="category-name">Computer Accessories</h1>
...
<div class="browse-view">
	...
	<div class="orderby-displaynumber clearfix">
		<div class="width70 floatleft">
			<div class="orderlistcontainer"><div class="title">Sort by</div><div class="activeOrder"><a title=" +/-" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=15&Itemid=557&dir=DESC">Product ID  +/-</a></div><div class="orderlist"><div><a title="Product Name" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=15&Itemid=557&orderby=product_name">Product Name</a></div><div><a title="Product SKU" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=15&Itemid=557&orderby=product_sku">Product SKU</a></div><div><a title="Manufacturer name" href="/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=15&Itemid=557&orderby=mf_name">Manufacturer name</a></div></div></div>					</div>
...
Results 1 - 1 of 1			</div>
	...
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=15&amp;categorylayout=0&amp;Itemid=557&amp;filter_product=&amp;keyword=&amp;limit=6" selected="selected">6</option>
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=15&amp;categorylayout=0&amp;Itemid=557&amp;filter_product=&amp;keyword=&amp;limit=12">12</option>
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=15&amp;categorylayout=0&amp;Itemid=557&amp;filter_product=&amp;keyword=&amp;limit=18">18</option>
	<option value="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=15&amp;categorylayout=0&amp;Itemid=557&amp;filter_product=&amp;keyword=&amp;limit=24">24</option>
</select>
		</div>
			...
			<div class="spacer">
				<div class="product-top">
					<div class="product-images">
						<a title="Computer Accessories" rel="vm-additional-images" href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=42&virtuemart_category_id=15&Itemid=557">
							<img src="/wereach/images/stories/virtuemart/product/resized/1_200x200.jpg" alt="1" class="browseProductImage" />					  </a>
					</div>
						
					<div class="product-name">
						<h2><a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=42&virtuemart_category_id=15&Itemid=557" >Computer Accessories</a></h2>
					</div>
				...
				<div class="product-info">
						...
						SPECIFICATIONS OF AUDIO TECHNICA...					</p>
					 
					
					
					<div class="product-price marginbottom12" id="productPrice42">
						<div class="PricevariantModification" style="display : none;" >Variant price modifier: <span class="PricevariantModification" ></span></div><div class="price-crossed" ><div class="PricebasePriceWithTax" style="display : block;" >Base price with tax: <span class="PricebasePriceWithTax" >34994,08 ₨</span></div></div><div class="PricesalesPriceWithDiscount" style="display : none;" >Salesprice with discount: <span class="PricesalesPriceWithDiscount" ></span></div><div class="PricesalesPrice" style="display : block;" >Sales price: <span class="PricesalesPrice" >34994,08 ₨</span></div><div class="PricepriceWithoutTax" style="display : block;" >Sales price without tax: <span class="PricepriceWithoutTax" >31812,80 ₨</span></div><div class="PricediscountAmount" style="display : none;" >Discount: <span class="PricediscountAmount" ></span></div><div class="PricetaxAmount" style="display : block;" >Tax amount: <span class="PricetaxAmount" >3181,28 ₨</span></div><div class="PriceunitPrice" style="display : none;" >Price / KG: <span class="PriceunitPrice" ></span></div>					</div>

					<p class="link-view-items">
						<a href="/wereach/index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=42&virtuemart_category_id=15&Itemid=557" title="Computer Accessories" class="product-details">Product details</a>					</p>
...
<ul class="VMmenu" id="VMmenu00_74186" >
...
<form action="http://webdesigninbangalore.co.in/wereach/index.php?option=com_virtuemart&view=category&virtuemart_category_id=15&categorylayout=0&Itemid=557" method="post">
...
<div class="ja-box column ja-box-right" style="width: 25%;">
	...
	<div class="acymailing_fulldiv" id="acymailing_fulldiv_formAcymailing44381"  >
		<form id="formAcymailing44381" action="/wereach/index.php?option=com_virtuemart&amp;view=category&amp;virtuemart_category_id=15&amp;categorylayout=0&amp;Itemid=557" onsubmit="return submitacymailingform('optin','formAcymailing44381')" method="post" name="formAcymailing44381"  >
		<div class="acymailing_module_form" >
			<div class="acymailing_introtext"><span style="color:#000;font-size:12px;text-align:justify;">Make sure you dont miss interesting happenings by joining our newsletter program. We don't do spam. Ever. Because that sucks.</span></div>						<div class="acymailing_form">
					<p class="onefield fieldacyemail" id="field_email_formAcymailing44381">								<span class="acyfield_email"><input id="user_email_formAcymailing44381" placeholder="E-mail" class="inputbox" type="text" name="user[email]" style="width:80%" value="" /></span>
							</p>
					
					<p class="acysubbuttons">
												<input class="button subbutton btn btn-primary" type="submit" value="Subscribe" name="Submit" onclick="try{ return submitacymailingform('optin','formAcymailing44381'); }catch(err){alert('The form could not be submitted '+err);return false;}"/>
											</p>
				</div>
						<input type="hidden" name="ajax" value="0"/>
			<input type="hidden" name="ctrl" value="sub"/>
			<input type="hidden" name="task" value="notask"/>
			<input type="hidden" name="redirect" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_virtuemart%26view%3Dcategory%26virtuemart_category_id%3D15%26categorylayout%3D0%26Itemid%3D557"/>
			<input type="hidden" name="redirectunsub" value="http%3A%2F%2Fwebdesigninbangalore.co.in%2Fwereach%2Findex.php%3Foption%3Dcom_virtuemart%26view%3Dcategory%26virtuemart_category_id%3D15%26categorylayout%3D0%26Itemid%3D557"/>
